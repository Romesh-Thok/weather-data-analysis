...
transform_task = GlueJobOperator(
    ...
    script_location='s3://aws-glue-assets-891612564500-eu-north-1/scripts/weather_data_ingestion.py',
    s3_bucket='s3://aws-glue-assets-891612564500-eu-north-1',  # S3 bucket where logs and local etl script will be uploaded
