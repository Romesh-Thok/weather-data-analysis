...
weather_dyf = glueContext.create_dynamic_frame.from_options(
    ...
    format="csv",
    connection_options={
        "paths": [f"s3://weather-data-rom/date={current_date}/weather_api_data.csv"],
        "recurse": True,
    },
...
redshift_output = glueContext.write_dynamic_frame.from_options(
    ...
    connection_options={
        "redshiftTmpDir": "s3://aws-glue-assets-891612564500-eu-north-1/temporary/",
        "useConnectionProperties": "true",
        "aws_iam_role": "arn:aws:iam::891612564500:role/redshift-role",
